export default function Tabletop() {
    ...
    return (
        <div className="flex justify-between">
            <div className="w-96 h-4 rounded-lg border border-black-150">
                <form class="max-w-md mx-auto">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block w-full h-6 p-4 ps-10 text-sm text-black border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-white dark:border-gray-600 dark:placeholder-black dark:text-grey-900 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
                    </div>
                </form>
            </div>
            <div className="flex gap-4">
                <div className="grid grid-flow-col items-center gap-2 h-9 pl-3.5 pr-3.5 border border-black-150">
                    <p className="">Sort</p>
